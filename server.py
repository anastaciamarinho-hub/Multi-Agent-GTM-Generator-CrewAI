...
# Load .env from the same directory as this server file. This works even when
# the command is started from a different working directory.
...
if not SERPAPI_API_KEY:
    raise RuntimeError(
        f"SERPAPI_API_KEY is missing. Add it to the .env file at: {ENV_FILE}"
    )
